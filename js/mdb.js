                            ...
                            for (var g = Math.min((e - h) / d.duration, 1), y = 0, x = s.length; x > y; y++) {
                                ...
                                if (a(S)) {
                                    ...
                                    for (var T in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(S, "visibility", d.visibility), k)
                                        if ("element" !== T) {
                                            var M, I = k[T],
                                                A = p.isString(I.easing) ? v.Easings[I.easing] : I.easing;
                                            if (1 === g) M = I.endValue;
                                            else {
                                                var P = I.endValue - I.startValue;
                                                if (M = I.startValue + P * A(g, d, P), !f && M === I.currentValue) continue
                                            }
                                            if (I.currentValue = M, "tween" === T) m = M;
                                            else {
                                                if (b.Hooks.registered[T]) {
                                                    var _ = b.Hooks.getRoot(T),
                                                        D = a(S).rootPropertyValueCache[_];
                                                    D && (I.rootPropertyValue = D)
                                                }
                                                var O = b.setPropertyValue(S, T, I.currentValue + (0 === parseFloat(M) ? "" : I.unitType), I.rootPropertyValue, I.scrollData);
                                                b.Hooks.registered[T] && (a(S).rootPropertyValueCache[_] = b.Normalizations.registered[_] ? b.Normalizations.registered[_]("extract", null, O[1]) : O[1]), "transform" === O[0] && (C = !0)
                                            }
                ...
                var x = function () {
                    ...
                    function r() {
                        function t(t) {
                            ...
                            if ("scroll" === M) {
                                var x, k, T, A = /^x$/i.test(c.axis) ? "Left" : "Top",
                                    P = parseFloat(c.offset) || 0;
                                c.container ? p.isWrapped(c.container) || p.isNode(c.container) ? (c.container = c.container[0] || c.container, T = (x = c.container["scroll" + A]) + u(r).position()[A.toLowerCase()] + P) : c.container = null : (x = v.State.scrollAnchor[v.State["scrollProperty" + A]], k = v.State.scrollAnchor[v.State["scrollProperty" + ("Left" === A ? "Top" : "Left")]], T = u(r).offset()[A.toLowerCase()] + P), d = {
                                    scroll: {
                                        rootPropertyValue: !1,
                                        startValue: x,
                                        currentValue: x,
                                ...
                                for (var D in _)
                                    if ("element" !== D) {
                                        var O = _[D].startValue;
                                        _[D].startValue = _[D].currentValue = _[D].endValue, _[D].endValue = O, p.isEmptyObject(w) || (_[D].easing = c.easing), v.debug && console.log("reverse tweensContainer (" + D + "): " + JSON.stringify(_[D]), r)
                                    } d = _
                            } else if ("start" === M) {
                                for (var E in a(r).tweensContainer && !0 === a(r).isAnimating && (_ = a(r).tweensContainer), u.each(y, function (t, e) {
                                    ...
                                    if (a(r).isSVG || "tween" === N || !1 !== b.Names.prefixCheck(N)[1] || b.Normalizations.registered[N] !== n) {
                                        (c.display !== n && null !== c.display && "none" !== c.display || c.visibility !== n && "hidden" !== c.visibility) && /opacity|filter/.test(E) && !V && 0 !== $ && (V = 0), c._cacheValues && _ && _[E] ? (V === n && (V = _[E].endValue + _[E].unitType), z = a(r).rootPropertyValueCache[N]) : b.Hooks.registered[E] ? V === n ? (z = b.getPropertyValue(r, N), V = b.getPropertyValue(r, E, z)) : z = b.Hooks.templates[N][1] : V === n && (V = b.getPropertyValue(r, E));
                                        var H, B, j, Y = !1;
                                        if (V = (H = f(E, V))[0], j = H[1], $ = (H = f(E, $))[0].replace(/^([+-\/*])=/, function (t, e) {
                                                return Y = e, ""
                                            }), B = H[1], V = parseFloat(V) || 0, $ = parseFloat($) || 0, "%" === B && (/^(fontSize|lineHeight)$/.test(E) ? ($ /= 100, B = "em") : /^scale/.test(E) ? ($ /= 100, B = "") : /(Red|Green|Blue)$/i.test(E) && ($ = $ / 100 * 255, B = "")), /[\/*]/.test(Y)) B = j;
                                        else if (j !== B && 0 !== V)
                                            if (0 === $) B = j;
                                            else {
                                                o = o || m();
                    ...
                    if (p.isWrapped(this) ? (d = !1, f = 0, g = this, h = this) : (d = !0, f = 1, g = k ? arguments[0].elements || arguments[0].e : arguments[0]), g = o(g)) {
                                ...
                                if (!u.isPlainObject(y) || p.isEmptyObject(y)) {
                                    if (p.isString(y) && v.Redirects[y]) {
                                        ...
                                        return !0 === E.backwards && (g = u.extend(!0, [], g).reverse()), u.each(g, function (t, e) {
                                            parseFloat(E.stagger) ? E.delay = _ + parseFloat(E.stagger) * t : p.isFunction(E.stagger) && (E.delay = _ + E.stagger.call(e, t, S)), E.drag && (E.duration = parseFloat(P) || (/^(callout|transition)/.test(y) ? 1e3 : m), E.duration = Math.max(E.duration * (E.backwards ? 1 - t / S : (t + 1) / S), .75 * E.duration, 200)), v.Redirects[y].call(e, e, E || {}, t, S, g, I.promise ? I : n)
                                        }), t()
                                    }
                        ...
                        if (u.each(g, function (t, e) {
                                p.isNode(e) && r.call(e)
                            }), (E = u.extend({}, v.defaults, w)).loop = parseInt(E.loop), O = 2 * E.loop - 1, E.loop)
                            for (var F = 0; O > F; F++) {
                                var $ = {
                                    delay: E.delay,
                                    progress: E.progress
                                };
                                F === O - 1 && ($.display = E.display, $.visibility = E.visibility, $.complete = E.complete), x(g, "reverse", $)
                            }
                        return t()
                    }
                };
                    ...
                    t.controllers.bar = t.DatasetController.extend({
                        ...
                        calculateBarIndexPixels: function (t, e, i) {
                            var n, o, r, s, l, c = i.scale.options,
                                ...
                                f = i.start,
                                m = i.end;
                            return 1 === p ? (n = h > f ? h - f : m - h, o = h < m ? m - h : h - f) : (e > 0 && (n = (h - d[e - 1]) / 2, e === p - 1 && (o = n)), e < p - 1 && (o = (d[e + 1] - h) / 2, 0 === e && (n = o))), l = (s = ((r = n * c.categoryPercentage) + o * c.categoryPercentage) / i.stackCount) * c.barPercentage, h -= r, h += s * u, {
                    ...
                    t.layoutService = {
                        ...
                        update: function (t, o, a) {
                            if (t) {
                                ...
                                i(h, !0), i(p, !1), i(f, !0), i(m, !1);
                                var v = o - l - c,
                                    y = a - u - d,
                                    b = y / 2,
                                    x = (o - v / 2) / (h.length + p.length),
                                    w = (a - b) / (f.length + m.length),
                                    k = v,
                                    S = y,
                                    C = [];
                                n.each(h.concat(p, f, m), function (t) {
                                    var e, i = t.isHorizontal();
                                    i ? (e = t.update(t.fullWidth ? v : k, w), S -= e.height) : (e = t.update(x, b), k -= e.width), C.push({
                                        horizontal: i,
                                        minSize: e,
                                        box: t
                                    })
                                ...
                                }), P = l, _ = c, D = u, O = d, n.each(h, function (t) {
                                    P += t.width
                                }), n.each(p, function (t) {
                                    _ += t.width
                                }), n.each(f, function (t) {
                                ...
                                P += E, _ += Math.max(M - _, 0);
                                var L = Math.max(I - D, 0);
                                D += L, O += Math.max(A - O, 0);
                                var R = a - D - O,
                                    F = o - P - _;
                                ...
                                var $ = l + E,
                                    W = u + L;
                                n.each(h.concat(f), N), $ += k, W += S, n.each(p, N), n.each(m, N), t.chartArea = {
                                    left: P,
                                    top: D,
                                    right: P + k,
                                    bottom: D + S
                            ...
                            function N(t) {
                                t.isHorizontal() ? (t.left = t.fullWidth ? l : P, t.right = t.fullWidth ? o - c : P + k, t.top = W, t.bottom = W + t.height, W = t.bottom) : (t.left = $, t.right = $ + t.width, t.top = D, t.bottom = D + S, $ = t.right)
                            }
                        }
                    }
                }
                        ...
                        draw: function (t) {
                            ...
                            if (o.display) {
                                var s = e.ctx,
                                    ...
                                    A = "right" === o.position ? e.left + w : e.right,
                                    P = "bottom" === o.position ? e.top : e.bottom - w,
                                    _ = "bottom" === o.position ? e.top + w : e.bottom;
                                if (a.each(g, function (i, n) {
                                        if (!a.isNullOrUndef(i.label)) {
                                            var r, s, d, p, v, y, b, x, k, S, C, D, O, E, L = i.label;
                                            ...
                                            if (m) {
                                                var W = w + $;
                                                "bottom" === o.position ? (F = f ? "middle" : "top", R = f ? "right" : "center", E = e.top + W) : (F = f ? "middle" : "bottom", R = f ? "left" : "center", E = e.bottom - W);
                                                var V = l(e, n, h.offsetGridLines && g.length > 1);
                                                V < e.left && (s = "rgba(0,0,0,0)"), V += a.aliasPixel(r), O = e.getPixelForTick(n) + u.labelOffset, v = b = k = C = V, y = P, x = _, S = t.top, D = t.bottom
                                            } else {
                                                var N, z = "left" === o.position;
                                                u.mirror ? (R = z ? "left" : "right", N = $) : (R = z ? "right" : "left", N = w + $), O = z ? e.right - N : e.left + N;
                                                var H = l(e, n, h.offsetGridLines && g.length > 1);
                                                H < e.top && (s = "rgba(0,0,0,0)"), H += a.aliasPixel(r), E = e.getPixelForTick(n) + u.labelOffset, v = I, b = A, k = t.left, C = t.right, y = x = S = D = H
                                            }
                                            M.push({
                                                tx1: v,
                                                ty1: y,
                                    ...
                                    var D, O, E = 0,
                                        L = r(p) / 2;
                                    if (m) D = e.left + (e.right - e.left) / 2, O = "bottom" === o.position ? e.bottom - L - C.bottom : e.top + L + C.top;
                                    else {
                                        var R = "left" === o.position;
                                        D = R ? e.left + L + C.top : e.right - L - C.top, O = e.top + (e.bottom - e.top) / 2, E = R ? -.5 * Math.PI : .5 * Math.PI
                                    }
                                    s.save(), s.translate(D, O), s.rotate(E), s.textAlign = "center", s.textBaseline = "middle", s.fillStyle = k, s.font = S.font, s.fillText(p.labelString, 0, 0), s.restore()
                                }
                                if (h.drawBorder) {
                                    ...
                                    m ? (W = V = "top" === o.position ? e.bottom : e.top, W += N, V += N) : (F = $ = "left" === o.position ? e.right : e.left, F += N, $ += N), s.beginPath(), s.moveTo(F, W), s.lineTo($, V), s.stroke()
                                }
                            }
                        }
                    })
                    ...
                    t.Tooltip = o.extend({
                        ...
                        update: function (e) {
                            ...
                            if (m.length) {
                                ...
                                }), f.title = d.getTitle(S, g), f.beforeBody = d.getBeforeBody(S, g), f.body = d.getBody(S, g), f.afterBody = d.getAfterBody(S, g), f.footer = d.getFooter(S, g), f.x = Math.round(x.x), f.y = Math.round(x.y), f.caretPadding = h.caretPadding, f.labelColors = w, f.labelTextColors = k, f.dataPoints = S, y = function (t, e, i) {
                                    var n = t.x,
                                        o = t.y,
                                        a = t.caretSize,
                                        r = t.caretPadding,
                        ...
                        getCaretPosition: function (t, e, i) {
                            ...
                            else if ("left" === d ? (n = (o = p + u + c) - c, a = o + c) : "right" === d ? (n = (o = p + m - u - c) - c, a = o + c) : (n = (o = p + m / 2) - c, a = o + c), "top" === h) s = (r = f) - c, l = r;
                            else {
                                s = (r = f + g) + c, l = r;
                                var v = a;
                                a = n, n = v
                ...
                n._set("global", {
                    ...
                    return {
                        ...
                        afterDatasetsUpdate: function (t, n) {
                            ...
                            for (l = 0; l < d; ++l)(u = p[l]) && (u.fill = r(p, l, h), u.boundary = i(u), u.mapper = s(u))
                        },
                        beforeDatasetDraw: function (t, e) {
                            ...
                            if (i) {
                                ...
                                d && h && u.length && (a.canvas.clipArea(o, t.chartArea), function (t, e, i, n, o, a) {
                                    var r, s, u, d, h, p, f, m = e.length,
                                        g = n.spanGaps,
                                        v = [],
                                        y = [],
                                        b = 0,
                                        x = 0;
                                    for (t.beginPath(), r = 0, s = m + !!a; r < s; ++r) h = i(d = e[u = r % m]._view, u, n), p = l(d), f = l(h), p && f ? (b = v.push(d), x = y.push(h)) : b && x && (g ? (p && v.push(d), f && y.push(h)) : (c(t, v, y, b, x), b = x = 0, v = [], y = []));
                                    ...
                                    x ? g + m >= l && (v = u.y += w, u.line++, g = u.x = t.left + (l - c[u.line]) / 2) : v + w > t.bottom && (g = u.x = g + t.columnWidths[u.line] + i.padding, v = u.y = t.top + i.padding, u.line++),
                                        function (t, i, n) {
                                            if (!(isNaN(y) || y <= 0)) {
                                                ...
                                                } else r || d.strokeRect(t, i, y, f), d.fillRect(t, i, y, f);
                                                d.restore()
                                            }
                        ...
                        draw: function () {
                            ...
                            if (i.display) {
                                ...
                                o.each(t.ticks, function (i, s) {
                                    ...
                                    var p = t.getDistanceFromCenterForValue(a.ticks.reverse ? t.min : t.max),
                                        f = s(t);
                                    i.textBaseline = "top";
                                    for (var m = r(t) - 1; m >= 0; m--) {
                                        if (l.display) {
                                            var g = t.getPointPosition(m, p);
                                            i.beginPath(), i.moveTo(t.xCenter, t.yCenter), i.lineTo(g.x, g.y), i.stroke(), i.closePath()
                                        }
                                        if (h.display) {
                                            var v = t.getPointPosition(m, p + 5),
                                                y = n(h.fontColor, e.defaultFontColor);
                                            i.font = f.font, i.fillStyle = y;
                                            var b = t.getIndexAngle(m),
                                                x = o.toDegrees(b);
                                            i.textAlign = c(x), d(x, t._pointLabelSizes[m], v), u(i, t.pointLabels[m] || "", v, f.size)
                                        }
                                    }
                                }(t)
                            }
                    ...
                    var e = t.Scale.extend({
                        ...
                        determineDataLimits: function () {
                            var t, e, i, o, l, c, h = this,
                                ...
                                b = [],
                                x = [];
                            for (t = 0, i = p.data.labels.length; t < i; ++t) x.push(f(p.data.labels[t], h));
                            for (t = 0, i = (p.data.datasets || []).length; t < i; ++t)
                                if (p.isDatasetVisible(t))
                                    if (l = p.data.datasets[t].data, a.isObject(l[0]))
                                        for (b[t] = [], e = 0, o = l.length; e < o; ++e) c = f(l[e], h), y.push(c), b[t][e] = c;
                                    else y.push.apply(y, x), b[t] = x.slice(0);
                            else b[t] = [];
                            x.length && (x = d(x).sort(u), g = Math.min(g, x[0]), v = Math.max(v, x[x.length - 1])), y.length && (y = d(y).sort(u), g = Math.min(g, y[0]), v = Math.max(v, y[y.length - 1])), g = f(m.min, h) || g, v = f(m.max, h) || v, g = g === s ? +n().startOf("day") : g, v = v === r ? +n().endOf("day") + 1 : v, h.min = Math.min(g, v), h.max = Math.max(g + 1, v), h._horizontal = h.isHorizontal(), h._table = [], h._timestamps = {
                                data: y,
                                datasets: b,
                                labels: x
                            }
                        ...
                        buildTicks: function () {
                            ...
                            for ("ticks" === s.bounds && d.length && (a = d[0], r = d[d.length - 1]), a = f(u.min, o) || a, r = f(u.max, o) || r, t = 0, e = d.length; t < e; ++t)(i = d[t]) >= a && i <= r && p.push(i);
                            return o.min = a, o.max = r, o._unit = u.unit || function (t, e, i, o) {
                                ...
                                }(p, u.minUnit, o.min, o.max), o._majorUnit = m(o._unit), o._table = function (t, e, i, n) {
                        ...
                        getLabelForIndex: function (t, e) {
                            ...
                            return a.isObject(r) && (o = this.getRightValue(r)), n.tooltipFormat && (o = p(o, n).format(n.tooltipFormat)), o
                        },
...
dropdownSelectors.on({
    ...
    function (t, e, i, n) {
        ...
        var O = "ontouchstart" in t,
            ...
            L = O && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),
            R = 25,
            F = 1,
            $ = 2,
            W = 4,
        ...
        function et(t, e) {
            return t === e ? N : c(t) >= c(e) ? t < 0 ? z : H : e < 0 ? B : j
        }
        ...
        Ot.prototype = {
            set: function (t) {
                "compute" == t && (t = this.compute()), Tt && this.manager.element.style && Dt[t] && (this.manager.element.style[Ct] = t), this.actions = t.toLowerCase().trim()
            },
            update: function () {
        ...
        function zt(t) {
            return t == j ? "down" : t == B ? "up" : t == z ? "left" : t == H ? "right" : ""
        }
        ...
        Vt.prototype = {
            ...
            getTouchAction: function () {
                var t = this.options.direction,
                    e = [];
                return t & Y && e.push(_t), t & X && e.push(Pt), e
            },
            directionTest: function (t) {
                var e = this.options,
                    ...
                    a = t.deltaX,
                    r = t.deltaY;
                return o & e.direction || (e.direction & Y ? (o = 0 === a ? N : a < 0 ? z : H, i = a != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === r ? N : r < 0 ? B : j, i = r != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
            },
            attrTest: function (t) {
                return Bt.prototype.attrTest.call(this, t) && (this.state & Lt || !(this.state & Lt) && this.directionTest(t))
            },
            emit: function (t) {
        ...
        function Kt(t, e) {
            var i;
            this.options = o({}, Zt.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = new((i = this).options.inputClass || (E ? ht : L ? bt : O ? kt : st))(i, K), this.touchAction = new Ot(this, this.options.touchAction), Gt(this, !0), p(this.options.recognizers, function (t) {
        ...
        function Gt(t, e) {
            ...
            n.style && (p(t.options.cssProps, function (o, a) {
                i = P(n.style, a), e ? (t.oldCssProps[i] = n.style[i], n.style[i] = o) : n.style[i] = t.oldCssProps[i] || ""
            }), e || (t.oldCssProps = {}))
        }
        Kt.prototype = {
            set: function (t) {
    ...
    function () {
        ...
        function C(t, e) {
            ...
            var O, E, L, R, F = n('<div class="clockpicker-tick"></div>');
            if (e.twelvehour)
                for (O = 0; O < 12; O += e.hourstep) E = F.clone(), L = O / 6 * Math.PI, R = y, E.css("font-size", "140%"), E.css({
                    left: v + Math.sin(L) * R - x,
                    top: v - Math.cos(L) * R - x
                }), E.html(0 === O ? 12 : O), p.append(E), E.on(u, V);
            else
                for (O = 0; O < 24; O += e.hourstep) {
                    E = F.clone(), L = O / 6 * Math.PI;
                    var $ = O > 0 && O < 13;
                    R = $ ? b : y, E.css({
                        left: v + Math.sin(L) * R - x,
                        top: v - Math.cos(L) * R - x
                    }), $ && E.css("font-size", "120%"), E.html(0 === O ? "00" : O), p.append(E), E.on(u, V)
                }
            var W = Math.max(e.minutestep, 5);
            for (O = 0; O < 60; O += W)
                for (O = 0; O < 60; O += 5) E = F.clone(), L = O / 30 * Math.PI, E.css({
                    left: v + Math.sin(L) * y - x,
                    top: v - Math.cos(L) * y - x
                }), E.css("font-size", "140%"), E.html(m(O)), C.append(E), E.on(u, V);
                ...
                if (!i || !(f < y - x || f > y + x)) {
                    ...
                    s && l.append(_.canvas), _.setHand(u, p, !i, !0), a.off(d).on(d, function (t) {
                        ...
                        (i || m) && o === u && s === p && _.setHand(o, s), "hours" === _.currentView ? _.toggleView("minutes", k / 2) : e.autoclose && (_.minutesView.addClass("clockpicker-dial-out"), setTimeout(function () {
                            _.done()
                        }, k / 2)), l.prepend(N), clearTimeout(g), _.popover.removeClass("clockpicker-moving"), a.off(d)
                    })
                }
            }
            if (l.on(u, function (t) {
                ...
                var N = r.find(".clockpicker-canvas"),
                    z = f("svg");
                z.setAttribute("class", "clockpicker-svg"), z.setAttribute("width", w), z.setAttribute("height", w);
                var H = f("g");
                ...
                var X = f("circle");
                X.setAttribute("class", "clockpicker-canvas-fg"), X.setAttribute("r", 5), H.appendChild(j), H.appendChild(Y), H.appendChild(X), H.appendChild(B), z.appendChild(H), N.append(z), this.hand = j, this.bg = Y, this.fg = X, this.bearing = B, this.g = H, this.canvas = N
            }
            T(this.options.init)
        }
    ...
    function (t, e) {
        ...
        return function (t, e, i, n) {
            ...
            o.extend(r, n);
            var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, S, C, T, M, I, A, P, _, D, O, E, L, R, F, $, W, V, N, z, H, B, j, Y, X, q, U, Q, Z, K, G, J, tt, et, it, nt, ot, at, rt, st, lt = {
                    x: 0,
                    y: 0
                },
                ct = {
                ...
                Nt = function (t, e, i, n) {
                    return n === a.currItem.initialZoomLevel ? (i[t] = a.currItem.initialPosition[t], !0) : (i[t] = Ot(t, n), i[t] > e.min[t] ? (i[t] = e.min[t], !0) : i[t] < e.max[t] && (i[t] = e.max[t], !0))
                },
                zt = function (t) {
                    var e = "";
                ...
                Yt = 0,
                Xt = function (t) {
                    jt[t] && (jt[t].raf && O(jt[t].raf), Yt--, delete jt[t])
                },
                qt = function (t) {
                ...
                Zt = {
                    ...
                    init: function () {
                        if (!s && !l) {
                            var i;
                            a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), E = t.className, s = !0, $ = o.detectFeatures(), D = $.raf, O = $.caf, A = $.transform, R = $.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = k = [{
                                ...
                                function () {
                                    ...
                                    A = "left", o.addClass(t, "pswp--ie"), _t = function (t, e) {
                                        e.left = t + "px"
                                    }, Pt = function (t) {
                            ...
                            e && (a.ui = new e(a, o)).init(), Ct("firstUpdate"), u = u || r.index || 0, (isNaN(u) || 0 > u || u >= Ne()) && (u = 0), a.currItem = Ve(u), ($.isOldIOSPhone || $.isOldAndroid) && (gt = !1), t.setAttribute("aria-hidden", "false"), r.modal && (gt ? t.style.position = "fixed" : (t.style.position = "absolute", t.style.top = o.getScrollY() + "px")), void 0 === F && (Ct("initialLayout"), F = L = o.getScrollY());
                            var c = "pswp--open ";
                            ...
                            R || o.bind(a.scrollWrap, f, a), St("initialZoomInEnd", function () {
                                ...
                                Yt || j || K || g !== a.currItem.initialZoomLevel || a.updateSize()
                            }, 1e3)), o.addClass(t, "pswp--visible")
                        }
                    },
                    close: function () {
                        s && (s = !1, l = !0, Ct("close"), o.unbind(window, "resize", a), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", Ft), $.transform && o.unbind(a.scrollWrap, "click", a), j && o.unbind(window, p, a), Ct("unbindEvents"), ze(a.currItem, null, !0, a.destroy))
                    },
                    destroy: function () {
                    ...
                    panTo: function (t, e, i) {
                        i || (t > J.min.x ? t = J.min.x : t < J.max.x && (t = J.max.x), e > J.min.y ? e = J.min.y : e < J.max.y && (e = J.max.y)), ut.x = t, ut.y = e, At()
                    },
                    handleEvent: function (t) {
                    ...
                    updateSize: function (e) {
                        ...
                        if (dt.x = a.scrollWrap.clientWidth, dt.y = a.scrollWrap.clientHeight, Bt(), ft.x = dt.x + Math.round(dt.x * r.spacing), ft.y = dt.y, Dt(ft.x * ht), Ct("beforeResize"), void 0 !== h) {
                            for (var n, s, l, c = 0; 3 > c; c++) n = k[c], _t((c + h) * ft.x, n.el.style), l = u + c - 1, r.loop && Ne() > 2 && (l = wt(l)), (s = Ve(l)) && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(n, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === n.index && l >= 0 && a.setContent(n, l), s && s.container && (Ye(s, dt), Qe(s), Pt(s));
                            w = !1
                        }
                        v = g = a.currItem.initialZoomLevel, (J = a.currItem.bounds) && (ut.x = J.center.x, ut.y = J.center.y, At(!0)), Ct("resize")
                    },
                    zoomTo: function (t, e, i, n, a) {
                        ...
                        Lt(s);
                        var d = function (e) {
                            1 === e ? (g = t, ut.x = s.x, ut.y = s.y) : (g = (t - l) * e + l, ut.x = (s.x - c) * e + c, ut.y = (s.y - u) * e + u), a && a(e), At(1 === e)
                        };
                ...
                Te = function (t, e) {
                    var i, n, o, s, l = ut[t] + e[t],
                        ...
                        u = ce.x + e.x,
                        d = ce.x - ne.x;
                    return i = l > J.min[t] || l < J.max[t] ? r.panEndFriction : 1, l = ut[t] + e[t] * i, !r.allowPanToNext && g !== a.currItem.initialZoomLevel || (tt ? "h" !== it || "x" !== t || X || (c ? (l > J.min[t] && (i = r.panEndFriction, J.min[t], n = J.min[t] - ct[t]), (0 >= n || 0 > d) && Ne() > 1 ? (s = u, 0 > d && u > ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l)) : (l < J.max[t] && (i = r.panEndFriction, J.max[t], n = ct[t] - J.max[t]), (0 >= n || d > 0) && Ne() > 1 ? (s = u, d > 0 && u < ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l))) : s = u, "x" !== t) ? void(et || Q || g > a.currItem.fitRatio && (ut[t] += e[t] * i)) : (void 0 !== s && (Dt(s, !0), Q = s !== ne.x), J.min.x !== J.max.x && (void 0 !== o ? ut.x = o : Q || (ut.x += e.x * i)), void 0 !== s)
                },
                Me = function (t) {
                    if (!("mousedown" === t.type && t.button > 0)) {
                        if (We) return void t.preventDefault();
                        if (!B || "mousedown" !== t.type) {
                            if (ve(t, !0) && t.preventDefault(), Ct("pointerDown"), P) {
                            ...
                            var i = Ce(t),
                                n = i.length;
                            Z = null, Ut(), j && 1 !== n || (j = nt = !0, o.bind(window, p, a), z = rt = ot = H = Q = q = Y = X = !1, it = null, Ct("firstTouchStart", i), Et(ct, ut), lt.x = lt.y = 0, Et(te, i[0]), Et(ee, te), ne.x = ft.x * ht, oe = [{
                                x: te.x,
                                y: te.y
                    ...
                    if (Z) {
                        ...
                        if (0 !== t)
                            if (Et(Kt, Z[0]), Jt.x = Kt.x - te.x, Jt.y = Kt.y - te.y, K && t > 1) {
                                ...
                                0 > n && (n = 0), be(Kt, Gt, se), lt.x += se.x - de.x, lt.y += se.y - de.y, Et(de, se), ut.x = Ot("x", i), ut.y = Ot("y", i), z = i > g, g = i, At()
                            } else {
                                if (!it) return;
                                ...
                                if ("v" === it && r.closeOnVerticalDrag && "fit" === r.scaleMode && g === a.currItem.initialZoomLevel) {
                                    lt.y += Jt.y, ut.y += Jt.y;
                                    var c = xe();
                                    return H = !0, Ct("onVerticalDrag", c), Mt(c), void At()
                                }(function (t, e, i) {
                                    if (t - V > 50) {
                                        var n = oe.length > 2 ? oe.shift() : {};
                                        n.x = e, n.y = i, oe.push(n), V = t
                                    }
                                })(Tt(), Kt.x, Kt.y), q = !0, J = a.currItem.bounds, Te("x", Jt) || (Te("y", Jt), Lt(ut), At())
                            }
                    }
                },
                Pe = function (t) {
                    ...
                    var e;
                    if (Ct("pointerUp"), ve(t, !1) && t.preventDefault(), P) {
                    ...
                    var c = -1;
                    if (0 === l && (j = !1, o.unbind(window, p, a), pe(), K ? c = 0 : -1 !== le && (c = Tt() - le)), le = 1 === l ? Tt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", K && 2 > l && (K = !1, 1 === l && (n = "zoomPointerUp"), Ct("zoomGestureEnded")), Z = null, q || X || et || H)
                        if (Ut(), N || (N = _e()), N.calculateSwipeSpeed("x"), H)
                            if (xe() < r.verticalDragRange) a.close();
                            else {
                                var u = ut.y,
                                    d = at;
                                Qt("verticalDrag", 0, 1, 300, o.easing.cubic.out, function (t) {
                                    ut.y = (a.currItem.initialPosition.y - u) * t + u, Mt((1 - d) * t + d), At()
                                }), Ct("onVerticalDrag", 1)
                            }
                    else {
                        if ((Q || et) && 0 === l) {
                        ...
                        if (!et) return "swipe" !== n ? void Le() : void(!Q && g > a.currItem.fitRatio && De(N))
                    }
                },
                _e = function () {
                    var t, e, i = {
                        ...
                        panAnimLoop: function () {
                            return jt.zoomPan && (jt.zoomPan.raf = D(i.panAnimLoop), i.now = Tt(), i.timeDiff = i.now - i.lastNow, i.lastNow = i.now, i.calculateAnimOffset("x"), i.calculateAnimOffset("y"), At(), i.calculateOverBoundsAnimOffset("x"), i.calculateOverBoundsAnimOffset("y"), i.speedDecelerationRatioAbs.x < .05 && i.speedDecelerationRatioAbs.y < .05) ? (ut.x = Math.round(ut.x), ut.y = Math.round(ut.y), At(), void Xt("zoomPan")) : void 0
                        }
                    };
                    return i
                },
                ...
                Oe = function (t, e) {
                    ...
                    var d, h = ft.x * ht,
                        p = Math.abs(h - ce.x);
                    return i || h > ce.x == e.lastFlickSpeed.x > 0 ? (d = Math.abs(e.lastFlickSpeed.x) > 0 ? p / Math.abs(e.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, re === u && (i = !1), et = !0, Ct("mainScrollAnimStart"), Qt("mainScroll", ce.x, h, d, o.easing.cubic.out, Dt, function () {
            ...
            xt("Gestures", {
                publicMethods: {
                    initGestures: function () {
                        ...
                        (P = $.pointerEvent) && $.touch && ($.touch = !1), P ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : $.touch ? (t("touch", "start", "move", "end", "cancel"), _ = !0) : t("mouse", "down", "move", "up"), p = T + " " + M + " " + I, f = C, P && !_ && (_ = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), a.likelyTouchDevice = _, m[C] = Me, m[T] = Ie, m[M] = Pe, I && (m[I] = m[M]), $.touch && (f += " mousedown", p += " mousemove mouseup", m.mousedown = m[C], m.mousemove = m[T], m.mouseup = m[M]), _ || (r.allowPanToNext = !1)
                    }
                }
            });
            var Re, Fe, $e, We, Ve, Ne, ze = function (e, i, n, s) {
                    var l;
                    ...
                    if (!d || !l || void 0 === l.x) return Ct("initialZoom" + (n ? "Out" : "In")), g = e.initialZoomLevel, Et(ut, e.initialPosition), At(), t.style.opacity = n ? 0 : 1, Mt(1), void(d ? setTimeout(function () {
                        h()
                    }, d) : h());
                    ! function () {
                        var i = c,
                            s = !a.currItem.src || a.currItem.loadError || r.showHideOpacity;
                        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (g = l.w / e.w, ut.x = l.x, ut.y = l.y - L, a[s ? "template" : "bg"].style.opacity = .001, At()), qt("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function () {
                            ...
                            if (Ct("initialZoom" + (n ? "Out" : "In")), n) {
                                var a = l.w / e.w,
                                    ...
                                    u = at,
                                    p = function (e) {
                                        1 === e ? (g = a, ut.x = l.x, ut.y = l.y - F) : (g = (a - c) * e + c, ut.x = (l.x - r.x) * e + r.x, ut.y = (l.y - F - r.y) * e + r.y), At(), s ? t.style.opacity = 1 - e : Mt(u - e * u)
                                    };
                                i ? Qt("initialZoom", 0, 1, d, o.easing.cubic.out, p, h) : (p(1), Re = setTimeout(h, d + 20))
                            } else g = e.initialZoomLevel, Et(ut, e.initialPosition), At(), Mt(1), s ? t.style.opacity = 1 : Mt(1), Re = setTimeout(h, d + 20)
                        }, n ? 25 : 90)
                    }()
                },
                He = {},
            ...
            xt("Controller", {
                publicMethods: {
                    ...
                    initController: function () {
                        o.extend(r, je, !0), a.items = Fe = i, Ve = a.getItemAt, Ne = r.getNumItemsFn, r.loop, Ne() < 3 && (r.loop = !1), St("beforeChange", function (t) {
                            var e, i = r.preload,
                                n = null === t || t >= 0,
                                o = Math.min(i[0], Ne()),
                                s = Math.min(i[1], Ne());
                    ...
                    setContent: function (t, e) {
                        ...
                        if (l) {
                                ...
                                if (l.loadComplete = function (i) {
                                        if (s) {
                                            if (t && t.index === e) {
                                                ...
                                                i.imageAppended ? !We && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : $.transform && (et || We) ? Be.push({
                                                    item: i,
                                                    baseDiv: c,
                                                    img: i.img,
                                                    index: e,
                            ...
                            $e || e !== u ? Pt(l) : (tt = c.style, ze(l, n || l.img)), t.el.innerHTML = "", t.el.appendChild(c)
                        } else t.el.innerHTML = ""
                    },
            ...
            xt("Tap", {
                ...
                publicMethods: {
                    ...
                    handleMouseWheel: function (t) {
                        if (g <= a.currItem.fitRatio) return r.modal && (!r.closeOnScroll || Yt || j ? t.preventDefault() : A && Math.abs(t.deltaY) > 2 && (c = !0, a.close())), !0;
    ...
    function (t, e) {
        ...
        return function (t, e) {
            ...
            x.init = function () {
                ...
                k && t.currItem ? (x.updateIndexIndicator(), g.captionEl && (g.addCaptionHTMLFn(t.currItem, o), I(o, "caption--empty", !t.currItem.title)), w = !0) : w = !1, S || _(), A()
